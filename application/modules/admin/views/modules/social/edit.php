			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="validate" role="form" class="form-horizontal" action="<?php echo base_url();?>admin/social/update/<?php echo $social_edit['id'];?>" method="post">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text"
									       ...
									       value="<?php echo ($this->input->post('social_name') ? $this->input->post('social_name') : $social_edit['social_name']); ?>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text"
									       ...
									       value="<?php echo ($this->input->post('social_url') ? $this->input->post('social_url') : $social_edit['social_url']); ?>" />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
									<select name="icon" class="validate[required] select" id="formIcon" data-width="fit">
										...
										<?php get_icons($social_edit['icon']);?>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
									<select name="status" class="validate[required] select" id="formStatus" data-width="fit">
										<option value="">Seçiniz</option>
										<?php get_status($social_edit['status'])?>
									</select>
								</div>
							</div>
