<?php
	if (!empty($galleryById[0])) {
		$galleryData = $galleryById[0];
		$formUrl = 'editSectionData/' . $galleryData['id'];
		$buttonName = 'Güncelle';
		$validateClass = '';
		$helpText = '/ <strong>Güncelleme yoksa boş bırakınız</strong>';
	} else {
		$formUrl = 'addSectionData';
		$buttonName = 'Ekle';
					...
					<div class="col-md-6">
						<form id="validate" role="form" class="form-horizontal"
							...
							<div class="form-group">
								<label class="col-md-3 control-label">Bölüm Adı</label>
								<div class="col-md-9">
									<input type="text" name="section_name" class="form-control validate[required]"
									       placeholder="Bölüm Adı" value="<?= @$galleryData['section_name'] ?>"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-3 control-label">Bölüm Fotosu</label>
								<div class="col-md-9">
									<input name="section_photo" type="file" id="file-simple"
									       class="<?= $validateClass ?>"
									       accept=".jpg,.png"/>
									<div class="help-block">Bölüm Fotoğrafını buraya ekleyiniz (maks 1
										adet) <?= $helpText ?></div>
								</div>
							</div>
							<div class="form-group">
		...
		<div class="col-md-12">
			...
			<div class="content-frame-body content-frame-body-left">
				...
				<div class="pull-right push-up-10">
					<div class="btn-group">
						<button class="btn btn-primary edit"><span class="fa fa-pencil"></span> Düzenle</button>
						<button class="btn btn-primary delete"><span class="fa fa-trash-o"></span> Sil</button>
					</div>
				</div>

				<div class="gallery" id="links">
					<?php
						foreach ($section_gallery as $Sgallery) {
							?>
							<a class="gallery-item"
							   href="<?= base_url() ?>gallery/sections/<?= $Sgallery['section_photo'] ?>"
							   title="<?= $Sgallery['section_name'] ?>" data-gallery>
								<div class="image">
									<img src="<?= base_url() ?>gallery/sections/<?= $Sgallery['section_photo'] ?>"
									...
									<ul class="gallery-item-controls">
										...
										<li>
											<span class="section-item-remove" id="<?= $Sgallery['id'] ?>"><i
